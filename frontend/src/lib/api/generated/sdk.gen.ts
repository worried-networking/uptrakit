 ...
 */
export const listClients = <ThrowOnError extends boolean = true>(options?: Options<ListClientsData, ThrowOnError>): RequestResult<ListClientsResponses, ListClientsErrors, ThrowOnError> => (options?.client ?? client).get<ListClientsResponses, ListClientsErrors, ThrowOnError>({
    security: [{
            key: 'oauth2',
            scheme: 'bearer',
            type: 'http'
 ...
 * Requires `ManageAuthSettings`.
 */
export const manualRegisterClient = <ThrowOnError extends boolean = true>(options: Options<ManualRegisterClientData, ThrowOnError>): RequestResult<ManualRegisterClientResponses, ManualRegisterClientErrors, ThrowOnError> => (options.client ?? client).post<ManualRegisterClientResponses, ManualRegisterClientErrors, ThrowOnError>({
    security: [{
            key: 'oauth2',
            scheme: 'bearer',
            type: 'http'
 ...
 * Requires `ManageAuthSettings`.
 */
export const revokeClient = <ThrowOnError extends boolean = true>(options: Options<RevokeClientData, ThrowOnError>): RequestResult<RevokeClientResponses, RevokeClientErrors, ThrowOnError> => (options.client ?? client).delete<RevokeClientResponses, RevokeClientErrors, ThrowOnError>({
    security: [{
            key: 'oauth2',
            scheme: 'bearer',
            type: 'http'
 ...
 * Requires `ManageAuthSettings`.
 */
export const trustClient = <ThrowOnError extends boolean = true>(options: Options<TrustClientData, ThrowOnError>): RequestResult<TrustClientResponses, TrustClientErrors, ThrowOnError> => (options.client ?? client).post<TrustClientResponses, TrustClientErrors, ThrowOnError>({
    security: [{
            key: 'oauth2',
            scheme: 'bearer',
            type: 'http'
 ...
 * Returns 404 when `oauth.enabled = false`.
 */
export const listConsents = <ThrowOnError extends boolean = true>(options?: Options<ListConsentsData, ThrowOnError>): RequestResult<ListConsentsResponses, ListConsentsErrors, ThrowOnError> => (options?.client ?? client).get<ListConsentsResponses, ListConsentsErrors, ThrowOnError>({
    security: [{
            key: 'oauth2',
            scheme: 'bearer',
            type: 'http'
 ...
 * Returns 204 on success.
 */
export const revokeConsent = <ThrowOnError extends boolean = true>(options: Options<RevokeConsentData, ThrowOnError>): RequestResult<RevokeConsentResponses, RevokeConsentErrors, ThrowOnError> => (options.client ?? client).delete<RevokeConsentResponses, RevokeConsentErrors, ThrowOnError>({
    security: [{
            key: 'oauth2',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const listAccessGrants = <ThrowOnError extends boolean = true>(options?: Options<ListAccessGrantsData, ThrowOnError>): RequestResult<ListAccessGrantsResponses, ListAccessGrantsErrors, ThrowOnError> => (options?.client ?? client).get<ListAccessGrantsResponses, ListAccessGrantsErrors, ThrowOnError>({
    security: [{
            key: 'oauth2',
            scheme: 'bearer',
            type: 'http'
 ...
 * Create a grant.
 */
export const createAccessGrant = <ThrowOnError extends boolean = true>(options: Options<CreateAccessGrantData, ThrowOnError>): RequestResult<CreateAccessGrantResponses, CreateAccessGrantErrors, ThrowOnError> => (options.client ?? client).post<CreateAccessGrantResponses, CreateAccessGrantErrors, ThrowOnError>({
    security: [{
            key: 'oauth2',
            scheme: 'bearer',
            type: 'http'
 ...
 * on commit.
 */
export const deleteAccessGrant = <ThrowOnError extends boolean = true>(options: Options<DeleteAccessGrantData, ThrowOnError>): RequestResult<DeleteAccessGrantResponses, DeleteAccessGrantErrors, ThrowOnError> => (options.client ?? client).delete<DeleteAccessGrantResponses, DeleteAccessGrantErrors, ThrowOnError>({
    security: [{
            key: 'oauth2',
            scheme: 'bearer',
            type: 'http'
 ...
 * Get a single grant.
 */
export const getAccessGrant = <ThrowOnError extends boolean = true>(options: Options<GetAccessGrantData, ThrowOnError>): RequestResult<GetAccessGrantResponses, GetAccessGrantErrors, ThrowOnError> => (options.client ?? client).get<GetAccessGrantResponses, GetAccessGrantErrors, ThrowOnError>({
    security: [{
            key: 'oauth2',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const updateAccessGrant = <ThrowOnError extends boolean = true>(options: Options<UpdateAccessGrantData, ThrowOnError>): RequestResult<UpdateAccessGrantResponses, UpdateAccessGrantErrors, ThrowOnError> => (options.client ?? client).put<UpdateAccessGrantResponses, UpdateAccessGrantErrors, ThrowOnError>({
    security: [{
            key: 'oauth2',
            scheme: 'bearer',
            type: 'http'
