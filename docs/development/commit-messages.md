...
Scopes typically match crate or component names: `agent`, `controller`, `plugin-infrastructure-core`, `plugin-releases-github`,
`plugin-discovery-phs`, `mqtt`, `web`, `cli`, `wire`, `core`.
...
- `refactor(plugin-releases-github): simplify release tag normalisation`
