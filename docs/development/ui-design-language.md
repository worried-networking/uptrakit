...
When a waiver is needed, register it in `docs/superpowers/ui-parity-waivers.json` and keep the
approved spec as the final authority on what the product should look like.
