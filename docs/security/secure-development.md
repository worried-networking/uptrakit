...
Developers must consult `docs/development/coding-standards.md` for error handling, panic policies, and design boundaries. Security-sensitive changes should also reference:
