...
- Hooks (systemd, Docker Compose, custom) log phase markers in their stdout for easier debugging. Document new hooks in `docs/development/provider-guidelines.md`.
