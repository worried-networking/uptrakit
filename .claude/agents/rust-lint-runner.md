...
1. **Run `cargo clippy --all-targets --all-features -- -D warnings`**: Execute clippy with all targets and features enabled, treating all warnings as errors. Capture the full output.

1. **Analyze and Summarize Results**: After both commands complete, produce a structured summary.
