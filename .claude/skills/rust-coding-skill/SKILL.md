...
## name: rust-coding-skill description: Guides Claude in writing idiomatic, efficient, well-structured Rust code using proper data modeling, traits, impl organization, macros, and build-speed best practices.
...
1. Plan data structures with precision:
...
1. Write idiomatic Rust implementations:
...
1. Apply rigorous documentation and code-style best practices:
...
1. Use macros effectively but responsibly:
...
1. Optimize build speed when relevant:
...
1. Encourage maintainable module and project structure:
...
1. Provide explanations and alternatives:\
...
1. Maintain clarity, safety, and idiomatic style at all times:\
