...
## [0.0.7](https://github.com/worried-networking/uptrakit/compare/uptrakit-agent-v0.0.6...uptrakit-agent-v0.0.7) - 2026-08-19

### Other

- updated the following local packages: uptrakit-wire, uptrakit-service-sdk, uptrakit-agent-runtime
...
## [0.0.3](https://github.com/worried-networking/uptrakit/compare/uptrakit-agent-v0.0.2...uptrakit-agent-v0.0.3) - 2026-05-18
...
- *(agent)* migrate AgentHandler to dyn ServiceTransport
- *(agent-core)* public functions accept Arc<dyn HostRuntime> instead of Arc<dyn CommandExecutor>
- *(agent-core)* update.rs accepts Arc<dyn HostRuntime> instead of Arc<dyn CommandExecutor>
- *(agent-core)* version_check accepts Arc<dyn HostRuntime> instead of Arc<dyn CommandExecutor>
- *(agent-core)* update module doc comment to reflect resumable post-hook scheduling
...
## [0.0.2](https://github.com/worried-networking/uptrakit/compare/uptrakit-agent-v0.0.1...uptrakit-agent-v0.0.2) - 2026-05-05
