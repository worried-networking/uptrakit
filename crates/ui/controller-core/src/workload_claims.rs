...
impl ClaimResult {
    /// Create a new [`ClaimResult`].
    pub fn new(
        granted: BTreeSet<String>,
        rejected: BTreeSet<String>,
        released: BTreeMap<String, Uuid>,
        tenants_after: BTreeSet<Uuid>,
        tenants_before: BTreeSet<Uuid>,
    ) -> Self {
        Self {
            granted,
            rejected,
...
impl Revocation {
    ...
    pub fn new(service_id: Uuid, revoked_keys: BTreeSet<String>) -> Self {
        Self {
            service_id,
            revoked_keys,
        }
