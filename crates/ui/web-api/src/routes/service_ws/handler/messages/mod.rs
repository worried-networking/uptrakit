...
use uptrakit_wire::{
    ControllerMessage, DiscoveryResultsPayload, HostConnectivityUpdate, ReportHostsPayload,
    ReportPagination, ReportPluginConfigPayload, ReportPluginConfigResponsePayload,
