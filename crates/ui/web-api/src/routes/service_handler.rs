...
use uptrakit_internal_wire::{
    ...
    ExecuteUpdatePayload, IncomingSeq, MqttClientConnectionStatus as WireMqttClientConnectionStatus,
    MqttRegisteredPayload, MqttTenantAssignmentsPayload, MqttTenantConfig, OutgoingSeq,
    PingPayload, PluginType, RejectedPayload, ServiceMessage, UpdateFinalStatus,
};
use uptrakit_shared_db::entity::{
    available_version, host, host_software_item, plugin_config, service, service_certificate,
    service_host, software_item, update_history, update_output_line,
};
...
// ---------------------------------------------------------------------------
// trigger_discovery_for_agent_host (public -- used by hosts.rs)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Private helper: MQTT register phase
// ---------------------------------------------------------------------------
...
struct MqttContext {
    instance_id: String,
    max_tenants: u32,
    tenant_configs: Vec<MqttTenantConfig>,
}
...
/// fails.
async fn handle_mqtt_register_phase(
    sink: &mut futures_util::stream::SplitSink<WebSocket, Message>,
    stream: &mut futures_util::stream::SplitStream<WebSocket>,
    state: &Arc<AppState>,
    service_id: uuid::Uuid,
...
// ---------------------------------------------------------------------------
// Private helper: sign_renewal_csr
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Private helper: load_linked_host_ids
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Private helper: validate_update_ownership
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Private helper: upsert_available_version
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Private helper: deliver_pending_updates
// ---------------------------------------------------------------------------
