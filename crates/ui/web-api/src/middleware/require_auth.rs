...
mod tests {
    ...
    async fn test_state(db: DatabaseConnection) -> Arc<AppState> {
        ...
        let (_, config_rx_for_require_auth) =
        ...
        Arc::new(AppState {
            ...
            auth: crate::app_state::AuthState::new(
                Arc::new(JwtManager::from_secret(b"test-secret-for-middleware-tests")),
            ...
            db_config_rx: config_rx_for_require_auth.db,
            network_config_rx: config_rx_for_require_auth.network,
            nats_config_rx: config_rx_for_require_auth.nats,
            tls_config_rx: config_rx_for_require_auth.tls,
            audit_config_rx: config_rx_for_require_auth.audit,
            log_config_rx: config_rx_for_require_auth.log,
