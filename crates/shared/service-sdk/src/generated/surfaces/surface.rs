...
pub enum SurfaceNode {
    ...
    KeyValue {
        data_source_id: crate::generated::surfaces::DataSourceId,
    },
    Table {
        data_source_id: crate::generated::surfaces::DataSourceId,
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
    ...
    Form {
        interaction_id: crate::generated::surfaces::InteractionId,
    },
    ActionBar {
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        action_ids: Vec<crate::generated::surfaces::InteractionId>,
    },
    Tabs {
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        tabs: Vec<SurfaceTab>,
...
pub struct SurfaceTableRowAction {
    pub interaction_id: crate::generated::surfaces::InteractionId,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct SurfaceTab {
    pub id: crate::generated::surfaces::SurfaceTabId,
    pub label: String,
...
pub struct SurfaceContextSelectorDescriptor {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub required_for_interactions: Vec<crate::generated::surfaces::InteractionId>,
}
impl SurfaceContextSelectorDescriptor {
    ...
    pub fn new(
        ...
        required_for_interactions: Vec<crate::generated::surfaces::InteractionId>,
    ) -> Self {
        Self {
