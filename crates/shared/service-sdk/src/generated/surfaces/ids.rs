...
macro_rules! identifier_type {
    ($name:ident) => {
        ...
        impl $name {
            #[doc = " Constructs a validated identifier instance."]
            #[doc = ""]
            #[doc = " # Errors"]
            #[doc = " Returns any [`IdentifierError`] produced by"]
            #[doc = " [`validate_surface_identifier`] when `value` does not satisfy"]
            #[doc = " the identifier contract."]
