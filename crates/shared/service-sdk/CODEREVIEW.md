...
**[MEDIUM]** `src/cert_handler.rs:293,312,324,345,436` -- Five `CertificateRenewalHandler` tests
use bare `#[tokio::test]`. Same file has correctly-annotated tests at lines 385, 397, 411 --
