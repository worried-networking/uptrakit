...
## [0.0.5](https://github.com/worried-networking/uptrakit/compare/uptrakit-service-sdk-v0.0.4...uptrakit-service-sdk-v0.0.5) - 2026-08-19
...
- *(tracing-init)* replace service-sdk's copied TracingBuilder with a real dependency
- update Cargo.toml dependencies

## [0.0.3](https://github.com/worried-networking/uptrakit/compare/uptrakit-service-sdk-v0.0.2...uptrakit-service-sdk-v0.0.3) - 2026-08-13
...
- *(wire)* validate icon names via shared kebab-case validator
...
- *(wire)* use MAX_ICON_NAME_LEN constant in oversized icon test cases
...
- *(wire)* add not_ready round-trip test for VersionCheckResult
