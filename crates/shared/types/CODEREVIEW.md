...
| ~~TYP-03~~ | ~~Major~~ | ~~Extensibility~~ | ~~`ProviderType` is a closed enum without `#[non_exhaustive]`.~~ **FIXED.** `#[non_exhaustive]` added. All exhaustive external matchers updated with wildcard arms. | `src/provider_types.rs` |
