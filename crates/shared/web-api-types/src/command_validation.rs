...
//! shell commands stored in plugin configs. These are logged as `security_audit:`
//! warnings but are **not blocking** — the `manage_commands` permission is
//! already documented as equivalent to RCE on managed hosts.
