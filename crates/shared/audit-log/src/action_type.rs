...
impl AuditActionType {
    ...
    pub const ACCESS_DENIED: RegisteredAuditAction =
        RegisteredAuditAction::new("access.denied", AuditActionKind::Event);
...
uptrakit_audit_log_derive::audit_actions! {
    ...
    // access denials — Event (M1.6b deny observability)
    access_denied => ACCESS_DENIED, Event;
