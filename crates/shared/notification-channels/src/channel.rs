//! Core notification channel trait and message types.
...
/// Trait implemented by each notification channel (webhook, Telegram, email, etc.).
///
/// The dispatcher calls [`deliver`](NotificationChannel::deliver) with a
/// fully-built [`DeliveryMessage`]. Channels render it into their native format
