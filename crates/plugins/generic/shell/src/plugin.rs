...
use uptrakit_plugin_infrastructure_core::{
    OutputStreamType, PluginCapability, PluginError, ReleaseInfo, Result, UpdateOutputLine,
...
mod tests {
    use super::*;
    use uptrakit_plugin_infrastructure_core::{
        LocalCommandExecutor, ReleaseInfo, UpdateExecutorPlugin, VersionDetectorPlugin,
    };
